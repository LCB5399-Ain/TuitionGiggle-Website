    ...
    <div class="container-box mt-2">
        ...
        <thead class="table-light">
            ...
            <tbody>
                ...
                $fetchQuery = "SELECT * FROM students ORDER BY fullName";
                ...
                if (mysqli_num_rows($resultData) > 0) {
                    while ($row = mysqli_fetch_array($resultData)) {
                        ...
                        if ((int)$row['tuitionID'] == (int)$_SESSION['tuitionID']) {
                            ...
                            $fetchQuery2 = "SELECT fullName FROM parents WHERE parents.studentID={$row['studentID']}";
                            ...
                            echo ("<td><a href=\"../edit_data/edit_students.php?studentID=".$row['studentID']."\">Edit</a></td>");
                            echo ("<td><a href=\"../delete_data/delete_students.php?studentID=".$row['studentID']."\">Delete</a></td>");
                            echo "</tr>";
                        }
                    }
                }
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <a type="submit" class="btn" href="../insert_data/insert_students.php">Add a student</a>
            </div>
        </div>
