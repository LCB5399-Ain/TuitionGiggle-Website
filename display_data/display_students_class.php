    ...
    <div class="container-box mt-2">
        ...
        <thead class="table-light">
            ...
            <tbody>
                ...
                // Retrieve studentID
                $studentGroupsID = isset($_GET['studentGroupsID']) ? (int)$_GET['studentGroupsID'] : '';

                $fetchQuery = "SELECT * FROM studentGroups WHERE studentGroups.classID={$studentGroupsID}";
                ...
                if ($resultData && mysqli_num_rows($resultData) > 0) {
                    while ($row = mysqli_fetch_array($resultData)) {
                        ...
                        if ((int)$row['tuitionID'] == (int)$_SESSION['tuitionID']) {
                            $studentGroupsID = $row['studentGroupsID'];
                            echo "<td>" . $row['studentGroupsID'] . "</td>";
                            ...
                            echo ("<td><a href=\"../delete_data/delete_students_class.php?studentID=".$row['studentID']."\">Delete</a></td>");
                            echo "</tr>";
                        }
                    }
                }
